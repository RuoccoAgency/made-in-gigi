...
import { Heart, Sparkles, Star, Flower2, Check } from "lucide-react";
                ...
                <section className="container mx-auto px-4 mt-32">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 max-w-4xl mx-auto">
                        {[
                            ...
                            { icon: Check, title: "Dettagli Curati", desc: "Ogni piccolo elemento è pensato per rendere l'evento indimenticabile." },
                        ].map((f, i) => (
