...
import { Sparkles, Palette, Camera, Check } from "lucide-react";
...
const GALLERY_IMAGES: string[] = ["/public/images/allestimenti.jpeg", "/public/images/allestimenti2.jpeg", "/public/images/allestimenti3.jpeg", "/public/images/allestimenti4.jpeg"];
      ...
      <main className="pt-24">
        <section className="container mx-auto px-4">
          ...
          >
            ...
            <h1 className="mt-4 text-4xl md:text-5xl font-display font-bold">Allestimenti</h1>
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              Decorazioni, balloon art e scenografie curate nei dettagli. Progettiamo un’atmosfera elegante e coerente con il tuo stile, dal primo ingresso fino all’ultimo scatto.
            </p>
            <div className="mt-8">
        ...
        <section className="container mx-auto px-4 mt-16">
          ...
          >
            {[
              { icon: Palette, title: "Moodboard", desc: "Palette e stile coordinati" },
              { icon: Sparkles, title: "Dettagli", desc: "Finiture premium e curate" },
              { icon: Camera, title: "Foto corner", desc: "Backdrop pronti per foto" },
            ].map((f, i) => (
        ...
        <section className="container mx-auto px-4 mt-16">
          <div className="flex items-end justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">Una selezione dei nostri allestimenti. (Bozza: immagini aggiornabili da array.)</p>
            </div>
          </div>
